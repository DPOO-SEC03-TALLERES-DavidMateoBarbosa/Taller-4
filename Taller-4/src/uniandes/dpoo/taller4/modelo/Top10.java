...
public class Top10
{
	...
	/**
	 * Indica si el puntaje indicado es suficiente para entrar al top10.txt
	 * 
	 * @param puntaje El puntaje que se va a revisar
	 * @return True si el puntaje debería estar en el top10.txt
	 */
	...
	/**
	 * Agrega un nuevo registro al top10.txt, en la posición correcta de acuerdo a la
	 * cantidad de puntos.
	 * 
	 * @param nombre  El nombre que debe quedar asociado al nuevo puntaje
	 * @param puntaje El puntaje que va a entrar al top10.txt
	 */
